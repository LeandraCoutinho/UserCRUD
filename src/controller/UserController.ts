...
export const fetchUsers = async (request: Request, response: Response): Promise<Response | void> => {
  try {
...
export const showUser = async (request: Request, response: Response): Promise<Response | void> => {
  try {
...
export const createUser = async (request: Request, response: Response): Promise<Response | void> => {
...
export const updateUser = async (request: Request, response: Response): Promise<Response | void> => {
  try {
    const userId = Number(request.params.id);
    const { name, email } = request.body;
...
export const deleteUser = async (request: Request, response: Response): Promise<Response | void> => {
  try {
    const userId = Number(request.params.id);
    const user = await UserService.getById(userId);
